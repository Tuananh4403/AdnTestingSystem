...
namespace AdnTestingSystem.Repositories.Migrations
{
    ...
    [Migration("20250730073454_AddRelationSipField")]
    partial class AddRelationSipField
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("AdnTestingSystem.Repositories.Models.BookingAttachment", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("AdnTestingSystem.Repositories.Models.SampleReceipt", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
                    ...
                    b.ToTable("SampleReceipts");
                });

            modelBuilder.Entity("AdnTestingSystem.Repositories.Models.SampleReceiptDetail", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
                    ...
                    b.HasIndex("SampleReceiptId");

                    b.ToTable("SampleReceiptDetails");
                });
            ...
            modelBuilder.Entity("AdnTestingSystem.Repositories.Models.TestResultDetail", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
                    ...
                    b.Property<string>("Allele1_Person1")
                        .IsRequired()
                        .HasColumnType("nvarchar(max)");

                    b.Property<string>("Allele1_Person2")
                        .IsRequired()
                        .HasColumnType("nvarchar(max)");

                    b.Property<string>("Allele2_Person1")
                        .IsRequired()
                        .HasColumnType("nvarchar(max)");

                    b.Property<string>("Allele2_Person2")
                        .IsRequired()
                        .HasColumnType("nvarchar(max)");
            ...
            modelBuilder.Entity("AdnTestingSystem.Repositories.Models.Booking", b =>
                {
                    ...
                    b.HasOne("AdnTestingSystem.Repositories.Models.User", "SampleCollector")
                        .WithMany()
            ...
            modelBuilder.Entity("AdnTestingSystem.Repositories.Models.SampleReceipt", b =>
                {
                    ...
                    b.HasOne("AdnTestingSystem.Repositories.Models.User", "CreatedBy")
                        .WithMany()
            ...
            modelBuilder.Entity("AdnTestingSystem.Repositories.Models.SampleReceiptDetail", b =>
                {
                    b.HasOne("AdnTestingSystem.Repositories.Models.SampleReceipt", "SampleReceipt")
                        .WithMany("SampleDetails")
                        .HasForeignKey("SampleReceiptId")
                        .OnDelete(DeleteBehavior.Restrict)
                        .IsRequired();

                    b.Navigation("SampleReceipt");
                });
            ...
            modelBuilder.Entity("AdnTestingSystem.Repositories.Models.Booking", b =>
                {
                    b.Navigation("BookingAttachments");
