    ...
    public partial class InitMigration : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_DnaTestServices", x => x.Id);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    Id = table.Column<int>(type: "int", nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                    DnaTestServiceId = table.Column<int>(type: "int", nullable: false),
                    ResultTimeType = table.Column<int>(type: "int", nullable: false),
                    SampleMethod = table.Column<int>(type: "int", nullable: false),
                    IsCivil = table.Column<bool>(type: "bit", nullable: false),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_ServicePrices_DnaTestServices_DnaTestServiceId",
                        column: x => x.DnaTestServiceId,
                        principalTable: "DnaTestServices",
                        principalColumn: "Id",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Bookings_DnaTestServices_DnaTestServiceId",
                        column: x => x.DnaTestServiceId,
                        principalTable: "DnaTestServices",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_BookingAttachments_Users_UploadedBy",
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    CollectorPhone = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    CollectorTitle = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    CreatedAt = table.Column<DateTime>(type: "datetime2", nullable: false),
                    CreatedBy = table.Column<int>(type: "int", nullable: true),
                    UpdatedAt = table.Column<DateTime>(type: "datetime2", nullable: true),
                    UpdatedBy = table.Column<int>(type: "int", nullable: true),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Samples_Bookings_BookingId",
                        column: x => x.BookingId,
                        principalTable: "Bookings",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateIndex(
                name: "IX_BookingAttachments_UploadedBy",
                table: "BookingAttachments",
                column: "UploadedBy");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Bookings_DnaTestServiceId",
                table: "Bookings",
                column: "DnaTestServiceId");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Samples_BookingId",
                table: "Samples",
                column: "BookingId");

            migrationBuilder.CreateIndex(
                name: "IX_ServicePrices_DnaTestServiceId",
                table: "ServicePrices",
                column: "DnaTestServiceId");

            migrationBuilder.CreateIndex(
                name: "IX_TestResults_BookingId",
                table: "TestResults",
                column: "BookingId",
                unique: true);
